...
export const PLANS: Record<PlanId, Plan> = {
  trial: {
    ...
    locked: ["Low-stock, promotion & custom alerts", "Scheduled campaigns", "Intent scoring", "ROI engine", "Advanced analytics", "Multi-store", "Staff roles"],
  },
  go: {
    id: "go",
    name: "Tag Go",
  ...
  growth: {
    ...
    features: [
      ...
      "Full campaign analytics · interest score",
  ...
  pro: {
    ...
    features: [
      ...
      "All 6 alert types · scheduled campaigns",
      "WhatsApp Inbox",
  ...
  enterprise: {
    ...
    features: [
      ...
      "All alert types · WhatsApp Inbox",
      "Scheduled campaigns",
