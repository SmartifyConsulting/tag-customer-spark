...
export const Route = createFileRoute("/_authenticated/interest-score")({
  head: () => ({ meta: [{ title: "Interest Score — Tag" }] }),
  beforeLoad: ({ context }) => requireFeature(context.queryClient, "interestScore"),
  component: InterestScorePage,
});
