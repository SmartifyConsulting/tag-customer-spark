...
import { FileDown, Layers, List, Loader2, Package, Plus } from "lucide-react";
...
function ProductsListPage() {
  ...
  const params = useMemo(
    () => ({
      ...
      status: (search.showArchived ? "archived" : "active") as "archived" | "active",
  ...
  return (
    <div className="grid gap-6">
          ...
          <ProductsToolbar
            ...
            onChange={(next) => {
              ...
              navigate({
                search: (p: any) => ({
                  ...p,
                  showArchived: "showArchived" in next ? !!next.showArchived : p.showArchived,
                  ...
                  >
                    <AccordionTrigger className="hover:no-underline">
                      <div className="flex flex-1 items-center gap-3 pr-3">
                        ...
                        {lowCount > 0 && <Badge variant="warning">{lowCount} low stock</Badge>}
                      </div>
                    </AccordionTrigger>
      ...
      <BulkQrDialog open={bulkOpen} onOpenChange={setBulkOpen} productIds={selectedIds} />
