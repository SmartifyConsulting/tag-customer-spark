...
import faviconAsset from "@/assets/tag-favicon.png.asset.json";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tag — Turning Interest into Sales" },
      { name: "description", content: "Tag helps retailers reconnect with in-store shoppers via QR-driven WhatsApp notifications." },
      { name: "author", content: "Tag" },
      { property: "og:title", content: "Tag — Turning Interest into Sales" },
      { property: "og:description", content: "Tag helps retailers reconnect with in-store shoppers via QR-driven WhatsApp notifications." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Tag — Turning Interest into Sales" },
