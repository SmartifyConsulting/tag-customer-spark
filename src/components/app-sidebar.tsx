      ...
      <SidebarFooter>
        {!collapsed && (
          <div className="space-y-2 px-3 py-3">
            {/* Search, then the profile row — the Tag Barcode Reader QR now
                lives on the Products page heading instead (all left-aligned,
                the ml-2 matches the Button's own px-2). */}
            <input
              type="text"
